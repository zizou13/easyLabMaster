        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity1" data-toggle="tab">A propos</a></li>
              <li ><a href="#activity" data-toggle="tab">Modifier</a></li>
...
<div class="modal fade" id="cc" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
                          <div class="modal-dialog">
                            ...
                            <div class="col-xs-8 inputGroupContainer input-group Date" style="width: 50%">
                              ...
                              <input name="dateR" type="text" class="form-control pull-right" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask id="datepicker" value="">
