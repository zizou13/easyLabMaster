  ...
  <body>
    ...
    <header role="banner">
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
          <a class="navbar-brand" href="index.html">Labo recherche<span>+</span>  </a>
          ...
          <div class="collapse navbar-collapse" id="navbarsExample05">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="services.html" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">EQUIPES</a>
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                  <a class="dropdown-item" href="equipe1.html">Equipe1: RSD</a>
                  <a class="dropdown-item" href="equipe2.html">Equipe2: GL</a>
              ...
              <li class="nav-item">
                <a class="nav-link" href="news.html">MEMBRES</a>
              </li>
              <li class="nav-item">
